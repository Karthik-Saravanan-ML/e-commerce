...
import { BookOpen, Headphones, Clock, ChevronLeft, ChevronRight, Play, Pause, Volume2, SkipBack, SkipForward, Crown, PenLine, ShieldCheck } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <div className="flex items-center justify-between mb-6">
        <h1 className="page-title flex items-center gap-2.5">
          <BookOpen className="w-6 h-6 text-primary-600" /> My Library
        </h1>
        ...
        <div className="inline-flex bg-gray-100 p-1 rounded-xl">
          {[
            ...
            <button key={key} onClick={() => setSelectedTab(key)}
              className={`flex items-center gap-2 px-6 py-2.5 rounded-lg font-medium text-sm transition-all ${selectedTab === key ? 'bg-white shadow text-primary-700' : 'text-gray-500'}`}>
